...
public interface RemoteUserService
{
    ...
    public SysUser selectSysUserByUserId(@PathVariable("userId") String userId);
    ...
    public Set<String> selectUserIdsHasRoles(@RequestParam("roleIds") String roleIds);
    ...
    public Set<String> selectUserIdsInDepts(@RequestParam("deptIds") String deptIds);
}
