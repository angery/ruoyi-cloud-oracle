...
public class SysMenuServiceImpl implements ISysMenuService
{
    ...
    @Override
    public List<SysMenu> selectMenuIdsByRoleId(String roleId)
    {
    ...
    public String checkMenuNameUnique(SysMenu menu)
    {
        if(StringUtils.isNotEmpty(menu.getMenuName())){
            ...
            if (StringUtils.isNotNull(info)&&StringUtils.isNotEmpty(info.getMenuId()))
            {
                if(StringUtils.isNotEmpty(menu.getMenuId())&&info.getMenuId().equals(menu.getMenuId())){
