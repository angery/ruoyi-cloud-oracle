...
public class SysConfigServiceImpl implements ISysConfigService
{
    ...
    public String checkConfigKeyUnique(SysConfig config)
    {
        if(StringUtils.isNotEmpty(config.getConfigKey())){
            ...
            if (StringUtils.isNotNull(info)&&StringUtils.isNotEmpty(info.getConfigId()))
            {
                if(StringUtils.isNotEmpty(config.getConfigId())&&info.getConfigId().equals(config.getConfigId())){
