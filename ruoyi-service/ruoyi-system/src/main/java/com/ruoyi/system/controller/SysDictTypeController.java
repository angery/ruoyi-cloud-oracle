...
public class SysDictTypeController extends BaseController
{
	...
	public SysDictType get(@PathVariable("dictId") String dictId)
	{
	...
	{
		if (UserConstants.DICT_TYPE_NOT_UNIQUE.equals(sysDictTypeService.checkDictTypeUnique(sysDictType)))
		{
			return R.error("该字典类型已存在");
		}
