...
public class SysRoleServiceImpl implements ISysRoleService
{
    ...
    public int insertRole(SysRole role)
    {
        ...
        SysRole roleDb = roleMapper.checkRoleNameUnique(role.getRoleName());
    ...
    public String checkRoleNameUnique(SysRole role)
    {
        if(StringUtils.isNotEmpty(role.getRoleName())){
            ...
            if (StringUtils.isNotNull(info)&&StringUtils.isNotEmpty(info.getRoleId()))
            {
                if(StringUtils.isNotEmpty(role.getRoleId())&&info.getRoleId().equals(role.getRoleId())){
